	...
	return (
		<Flex className="mb-header">
			...
			<Flex gap={ 3 } expanded={ false } className="mb-header__actions">
				...
				<Button onClick={ updateSidebarPanel( 'add_field' ) } className="is-compact" icon={ plusCircle } size="compact" label={ __( 'Add a new field', 'meta-box-builder' ) } showTooltip={ true } isPressed={ sidebarPanel === 'add_field' } />
