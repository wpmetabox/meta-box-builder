...
export const Options = [
	...
	{ type: 'text', name: 'icon_dashicons', label: __( 'Icon', 'mb-settings-page-ui' ), dependency: 'icon_type:dashicons' },
	{ type: 'text', name: 'icon_url', label: __( 'Icon URL', 'mb-settings-page-ui' ), dependency: 'icon_type:svg,custom' },
