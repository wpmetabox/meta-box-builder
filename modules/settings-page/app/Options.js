...
export const Options = [
	...
	{ type: 'select', name: 'icon_type', options: iconTypes, label: __( 'Icon', 'mb-settings-page-ui' ) },
	...
	{ type: 'select', name: 'style', label: __( 'Style', 'mb-settings-page-ui' ), options: styles },
	...
	{ type: 'select', name: 'tab_style', label: __( 'Tab style', 'mb-settings-page-ui' ), options: tabStyles },
