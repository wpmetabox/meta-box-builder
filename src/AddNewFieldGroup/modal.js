			...
			<div class="mbb-modal-content">
				...
				<div class="mbb-modal-body">
					...
					<div class="mbb-mode-options">
						<a href="${ data.adminUrl }post-new.php?post_type=meta-box&settings[mode]=custom-fields" class="mbb-mode-option">
						...
						${ hasFrontendSubmission ? `
							<a href="${ data.adminUrl }post-new.php?post_type=meta-box&settings[mode]=post-submission-form" class="mbb-mode-option">
								<div class="mbb-mode-icon">
						...
						${ hasBlocks ? `
							<a href="${ data.adminUrl }post-new.php?post_type=meta-box&settings[mode]=block" class="mbb-mode-option">
								<div class="mbb-mode-icon">
