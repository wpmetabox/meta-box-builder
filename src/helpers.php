<?php
if ( ! function_exists( 'mbb_get_field_edit_content' ) ) {
	/**
...
if ( ! function_exists( 'mbb_get_attribute_content' ) ) {
...
if ( ! function_exists( 'mbb_get_setting_pages' ) ) {
...
if ( ! function_exists( 'mbb_get_categories' ) ) {
...
if ( ! function_exists( 'mbb_get_builder_menu' ) ) {
	/**
...
if ( ! function_exists( 'mbb_get_current_tab' ) ) {
