...
use MetaBox\Dependencies\Twig\ExpressionParser;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\AddBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\AndBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\BitwiseAndBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\BitwiseOrBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\BitwiseXorBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\ConcatBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\DivBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\EndsWithBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\EqualBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\FloorDivBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\GreaterBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\GreaterEqualBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\InBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\LessBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\LessEqualBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\MatchesBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\ModBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\MulBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\NotEqualBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\NotInBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\OrBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\PowerBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\RangeBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\SpaceshipBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\StartsWithBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\SubBinary;
use MetaBox\Dependencies\Twig\Node\Expression\Filter\DefaultFilter;
use MetaBox\Dependencies\Twig\Node\Expression\NullCoalesceExpression;
use MetaBox\Dependencies\Twig\Node\Expression\Test\ConstantTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\DefinedTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\DivisiblebyTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\EvenTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\NullTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\OddTest;
use MetaBox\Dependencies\Twig\Node\Expression\Test\SameasTest;
use MetaBox\Dependencies\Twig\Node\Expression\Unary\NegUnary;
use MetaBox\Dependencies\Twig\Node\Expression\Unary\NotUnary;
use MetaBox\Dependencies\Twig\Node\Expression\Unary\PosUnary;
use MetaBox\Dependencies\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use MetaBox\Dependencies\Twig\TokenParser\ApplyTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\BlockTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\DeprecatedTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\DoTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\EmbedTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\ExtendsTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\FlushTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\ForTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\FromTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\IfTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\ImportTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\IncludeTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\MacroTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\SetTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\UseTokenParser;
use MetaBox\Dependencies\Twig\TokenParser\WithTokenParser;
use MetaBox\Dependencies\Twig\TwigFilter;
use MetaBox\Dependencies\Twig\TwigFunction;
use MetaBox\Dependencies\Twig\TwigTest;
...
namespace {
    ...
    use MetaBox\Dependencies\Twig\Error\RuntimeError;
    use MetaBox\Dependencies\Twig\Extension\CoreExtension;
    use MetaBox\Dependencies\Twig\Extension\SandboxExtension;
    use MetaBox\Dependencies\Twig\Markup;
 ...
 * @param string $type              The type of attribute (@see \MetaBox\Dependencies\Twig\Template constants)
 ...
 *
 * @throws RuntimeError if the attribute does not exist and MetaBox\Dependencies\Twig is running in strict mode and $isDefinedTest is false
 *
 * @internal
 */
function twig_get_attribute(Environment $env, Source $source, $object, $item, array $arguments = [], $type = /* Template::ANY_CALL */ 'any', $isDefinedTest = false, $ignoreStrictCheck = false, $sandboxed = false, int $lineno = -1)
{
    ...
    if ($object instanceof Template) {
        throw new RuntimeError('Accessing \MetaBox\Dependencies\Twig\Template attributes is forbidden.', $lineno, $source);
    }
...
function twig_array_filter(Environment $env, $array, $arrow)
{
    ...
    if (!$arrow instanceof Closure && $env->hasExtension('\MetaBox\Dependencies\Twig\Extension\SandboxExtension') && $env->getExtension('\MetaBox\Dependencies\Twig\Extension\SandboxExtension')->isSandboxed()) {
